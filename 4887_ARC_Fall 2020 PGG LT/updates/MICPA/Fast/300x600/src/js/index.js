...
(function () {
	...
	nameSpace.init = function () {
		...
		click_through.onmouseover = function () {
			TweenMax.to("#cta", 0.1, { scale: 1.1, y: 0, transformOrigin: "75% 90%", rotationZ: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		};
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.to(["#copy-1"], 0.4, { x:-3400, y:440, scale:40, transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Linear.easeNone, onComplete:nameSpace.hideBg}, "+=1.5")
