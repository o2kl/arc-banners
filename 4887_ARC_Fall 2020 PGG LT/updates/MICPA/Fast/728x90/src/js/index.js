...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set(['#logo','#logo2', "#copy-2", "#copy-3", "#copy-4"], { x: 0, autoAlpha: 0 });
		...
		click_through.onmouseover = function () {
			TweenMax.to("#cta", 0.1, { scale: 1.05, y: 0, transformOrigin: "88% 65%", rotationZ: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		};
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.to(["#copy-1"], 0.4, { x:-9800, y:440, scale:50, transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Linear.easeInOut, onComplete:nameSpace.hideBg  }, "+=1.5")
