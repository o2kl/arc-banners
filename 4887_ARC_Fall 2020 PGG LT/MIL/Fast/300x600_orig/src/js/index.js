...
(function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.to(["#copy-1"], 0.4, { x:-2400, y:440, scale:40, transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Linear.easeNone, onComplete:nameSpace.hideBg }, "+=1.5")
